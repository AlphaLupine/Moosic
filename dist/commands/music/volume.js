...
class VolumeCommand extends discord_akairo_1.Command {
    constructor() {
        super('volume', {
            aliases: ['volume', 'vol'],
            args: [
    ...
    exec(message, { volume }) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!volume)
                return message.reply(`current volume of music player ${player.volume}`);
            if (volume < 1 || volume > 100)
                return message.reply('Volume can only be changed from 1-100%');
